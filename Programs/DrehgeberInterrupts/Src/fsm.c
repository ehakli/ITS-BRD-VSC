...
static volatile char last_phase = PHASE_B; /*Start*/
static volatile int phasen_counter = 0;
static volatile char direction  = 'i'; /*indikator für die richtung startet bei i = idle*/
